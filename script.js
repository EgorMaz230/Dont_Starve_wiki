...
//     const food = [
//         { name: "Медові наггетси", imgSrc: "./img/nugets.webp" },
//         { name: "Вареники", imgSrc: "./img/vareniki.webp" },
...
//         { name: "Вафлі", imgSrc: "./img/wafels.webp" },
//         { name: "Звичайний омлет", imgSrc: "./img/amlet.webp" },
//         { name: "Медовий рулет", imgSrc: "./img/medowyj.webp" }
//     ];

//     const gameplay = [
//         { name: "Інструменти", imgSrc: "./img/instru.webp" },
//         { name: "Освітлення", imgSrc: "./img/ogon.webp" },
//         { name: "Матеріали", imgSrc: "./img/materials.webp" },
//         { name: "Наука", imgSrc: "./img/nauka.webp" },
//         { name: "Бій", imgSrc: "./img/boj.webp" },
//         { name: "Морське", imgSrc: "./img/more.webp" },
//         { name: "Магія", imgSrc: "./img/magia.webp" },
//         { name: "Одяг", imgSrc: "./img/odezda.webp" }
//     ];

//     const characters = [
//         { name: "Уилсон", imgSrc: "./img/цшдіщт.webp" },
//         { name: "Уиллоу", imgSrc: "./img/wilow.webp" },
//         { name: "Вольфганг", imgSrc: "./img/wolfgang.webp" },
//         { name: "Венді", imgSrc: "./img/wendy.webp" },
...
//         link.href = item.url || "#";  // Если нет ссылки, указываем заглушку "#"

//         const heartIcon = document.createElement('span');
//         heartIcon.classList.add('heart-icon', 'far', 'fa-heart'); // Используем Font Awesome классы
